AFRAME.registerComponent("bullets", {
 ...
 removeBullet: function (e) {
    ...
    if (elementHit.id.includes("enemy")) {
      //Add code here
      var countEnemyShipEl = document.querySelector("#countEnemyShip")
      var enemyShipFired = parseInt(countEnemyShipEl.getAttribute("text").value)
      enemyShipFired -= 1
      countEnemyShipEl.setAttribute("text", {value: enemyShipFired})
      if(enemyShipFired === 0){
